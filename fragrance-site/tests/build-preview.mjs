...
assert.deepEqual(assetPaths.filter(file => file.startsWith('type90s/')).sort(), [
  'type90s/campaign-02-640.webp', 'type90s/campaign-02.webp',
  'type90s/web-hero-wide-960.webp', 'type90s/web-hero-wide.webp',
]);
