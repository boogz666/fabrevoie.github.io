...
function fixture(overrides = {}) {
  const values = {
    ...
    price: { id: env.STRIPE_PRICE_ID, active: true, livemode: false, type: 'one_time', recurring: null, billing_scheme: 'per_unit', currency: 'eur', unit_amount: 12500, tax_behavior: 'inclusive', product: { id: 'prod_private', active: true, livemode: false, tax_code: 'txcd_12345678', metadata: { confidential: 'PRIVATE-PRODUCT' } } },
